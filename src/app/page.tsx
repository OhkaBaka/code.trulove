    ...
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      ...
      <div className="mb-32 grid text-center lg:mb-0 lg:w-full lg:max-w-5xl lg:grid-cols-4 lg:text-left">
        <a
          ...
          className="group rounded-lg border border-transparent p-2 m-2 transition-colors bg-neutral-600/50 hover:border-gray-150 hover:bg-gray-50 hover:dark:border-neutral-700 hover:dark:bg-neutral-800/30"
          target="_blank"
